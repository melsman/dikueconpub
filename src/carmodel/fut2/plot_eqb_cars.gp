...
set term pdf
set output "plot_eqb_cars.pdf"
plot "bench_solve_cars.dat" u 2:(stringcolumn(6) eq "C"?$7:1/0) title "Futhark c" with lines, \
     ...
     "matlab_eqb_cars.dat" u 2:6 title "Matlab" with lines
